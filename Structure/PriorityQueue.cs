...
namespace System.Collections.Generic
{
    ...
    public class PriorityQueue<TElement, TPriority>
    {
        ...
        {
            if (initialCapacity < 0) throw new ArgumentException("InitialCapacity can't be negative");
        ...
        {
            if (items == null) throw new ArgumentException(null);
        ...
        {
            if (elements == null) throw new ArgumentException(null);
        ...
        public sealed class UnorderedItemsCollection : IReadOnlyCollection<(TElement Element, TPriority Priority)>, ICollection
        {
            ...
            {
                if (array == null) throw new ArgumentException(null);
